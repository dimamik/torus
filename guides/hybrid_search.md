...
An empty search term contributes no rows to the fusion: `full_text` branches default `empty_return` to `false`, and `similarity`/`bm25` branches filter empty terms out.
